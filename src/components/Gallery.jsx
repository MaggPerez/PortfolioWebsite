        ...
        <section id="MyProjects" class="text-gray-600 dark:text-white body-font dark:bg-black h-screen">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-wrap w-full mb-20">
                    ...
                    <p class="lg:w-1/2 w-full leading-relaxed text-gray-500 text-xl">These are the projects that I have developed using various tools such as React, JavaScript/Typescript, HTML/CSS, Tailwind CSS, JavaFX, Firebase, Microsoft Access, AWS, PineconeDB.</p>
                </div>
                ...
                <div class="flex flex-wrap -m-4">
                    ...
                    <div class="xl:w-1/4 md:w-1/2 p-4">
                        <div class="bg-gray-100 dark:bg-zinc-900 p-6 rounded-lg">
                            <a href="https://github.com/abdkhan-git/lawdoc-ai" target="_blank">
                                <img class="h-40 rounded w-full object-cover object-center mb-6" src="/images/LawDocAi.png" alt="content" />
                            </a>
                            <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">PROJECT</h3>
                            <h2 class="text-lg text-gray-900 dark:text-indigo-300 font-medium title-font mb-4">LawDoc AI</h2>
                    ...
                    <div class="xl:w-1/4 md:w-1/2 p-4">
                        <div class="bg-gray-100 dark:bg-zinc-900 p-6 rounded-lg">
                            <img class="h-40 rounded w-full object-cover object-center mb-6" src="/images/movie_mine.png" alt="content" />
                            <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">PROJECT</h3>
