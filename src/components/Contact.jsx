export default function Contact() {
    return (
        <section id="contact" className="text-gray-600 dark:text-white body-font py-24 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-900">
            <div className="container mx-auto px-5 max-w-6xl">
                <div className="text-center mb-16">
                    <h2 className="sm:text-4xl text-3xl font-bold title-font mb-4 text-gray-900 dark:text-white">Let's Connect</h2>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-300 mb-8 text-lg">
                            Whether you're looking to hire a passionate software engineer, collaborate on a project, or just want to connect, I'd love to hear from you.
                        </p>
                        
                        <div className="space-y-6">
                            <div className="flex items-center">
                                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300">magdaleno.perez@example.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300">github.com/MaggPerez</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-300">linkedin.com/in/magdaleno-perez</p>
                                </div>
                            </div>
                        </div>
                    </div>
